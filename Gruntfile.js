...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      compass: {
        files: ['<%= config.app %>/assets/sass/{,*/}*.{scss,sass}','<%= config.app %>/assets/sass/{,*/}/{,*/}*.{scss,sass}'],
      ...
      livereload: {
        ...
        files: [
          '<%= config.app %>/app/{,*/}*.html',
          '<%= config.app %>/app/{,*/}*.js',
          '<%= config.app %>/app/states/{,*/}*.html',
          '<%= config.app %>/app/states/{,*/}*.js',
          '<%= config.app %>/app/directives/{,*/}*.html',
          '<%= config.app %>/app/directives/{,*/}*.js',
          '.tmp/css/{,*/}*.css',
    ...
    // Automatically inject Bower states into the HTML file
    wiredep: {
    ...
    jsdoc : {
      dist : {
        src: ['<%= config.app %>/app/{,*/}*.js', 'README.md'],
        options: {
